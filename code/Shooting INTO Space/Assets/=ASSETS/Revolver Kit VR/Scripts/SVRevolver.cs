...
public class SVRevolver : MonoBehaviour {
	...
	[Header("Gun name")]
	public bool rose;
	public int rosebullet ;
	public bool electric;
	public int electricbullet ;
	public bool sand;
	public int sandbullet;
	public int sandgun;
	...
	public int numberOfChambers = 500;
	...
	private void Awake()
	{
		firstplay = PlayerPrefs.GetInt("first");
	}
	void Start () {
		...
		if(firstplay == 0)
		{
			PlayerPrefs.SetInt("rosebullet", 300);
			
			PlayerPrefs.SetInt("electricbullet", 500);
		
			PlayerPrefs.SetInt("sandbulet", 700);
	...
	void Update () {
		sandgun = PlayerPrefs.GetInt("sandgun");
		if (sand == true && sandgun == 0)
		{
			this.gameObject.SetActive(false);
		}
		if (sand == true && sandgun == 1)
		{
			this.GetComponent<SVGrabbable>().enabled = true;
		}
		...
		if(rose == true) {
			rosebullet = PlayerPrefs.GetInt("rosebullet");
			maxBullets = rosebullet;
		}
		if (electric == true)
		{
			electricbullet = PlayerPrefs.GetInt("electricbullet");
			maxBullets = electricbullet;
		}
		if (sand == true)
		{
			sandbullet = PlayerPrefs.GetInt("sandbullet");
			maxBullets = sandbullet;
		}
